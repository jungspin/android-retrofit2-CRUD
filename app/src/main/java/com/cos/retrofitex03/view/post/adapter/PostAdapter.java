package com.cos.retrofitex03.view.post.adapter;
...
import com.cos.retrofitex03.view.post.PostDetailActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.MyViewHolder> {
    ...
    private PostAdapter postAdapter = this;
...
//            itemView.setOnClickListener(v-> { // holder 가 내가 만든 홀더기때매 itemView 접근 가능
